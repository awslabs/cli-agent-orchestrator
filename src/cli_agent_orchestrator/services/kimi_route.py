...
def _digest_or_absent(path: pathlib.Path) -> str:
    """Digest the config as Kimi will read it, or report it absent.
    ...
    file yields exactly the bytes Kimi itself will read, and if either the

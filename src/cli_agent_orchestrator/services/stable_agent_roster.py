...
ACQUISITION_STATUS_DISCOVERED = native_attachment.ACQUISITION_STATUS_DISCOVERED
ACQUISITION_CONTROLLED_BOOTSTRAP_TURN = native_attachment.ACQUISITION_CONTROLLED_BOOTSTRAP_TURN

...
# registered here through the cao.plugins entry-point group. Additive hooks run
# best-effort; a requested security restriction can abort startup. The surface is
# default-off: a no-op unless CAO_MCP_APPS_ENABLED is set, so the default posture
# is unchanged.

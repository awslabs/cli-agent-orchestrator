...
**Files:** `test/e2e/test_handoff.py`, `test_assign.py`, `test_send_message.py`
- Add test classes: `Test<Provider>Handoff` (2 tests), `Test<Provider>Assign` (2 tests), `Test<Provider>SendMessage` (1 test)

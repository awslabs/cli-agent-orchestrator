...
- [Lessons Learned](./references/lessons-learned.md) — 15 critical bugs and their fixes (load during Phase 2)
...
cp skills/build-cao-provider/templates/ralph/PROMPT.md .ralph/PROMPT.md
cp skills/build-cao-provider/templates/ralph/fix_plan.md .ralph/fix_plan.md
cp skills/build-cao-provider/templates/ralph/AGENT.md .ralph/AGENT.md
cp skills/build-cao-provider/templates/ralph/ralphrc .ralphrc
